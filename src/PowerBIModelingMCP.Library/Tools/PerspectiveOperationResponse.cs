...
// Type: PowerBIModelingMCP.Library.Tools.PerspectiveOperationResponse
...
public class PerspectiveOperationResponse
{
  ...
  [Description("The name of the perspective that was operated on")]
  public string? PerspectiveName { get; set; }

  [Description("Result data for get_perspective and list_perspectives operations")]
