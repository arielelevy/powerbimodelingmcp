...
// Type: PowerBIModelingMCP.Library.Tools.CalculationGroupOperationResponse
...
public class CalculationGroupOperationResponse
{
  ...
  [Description("The name of the calculation group that was operated on")]
  public string? CalculationGroupName { get; set; }

  [Description("The name of the calculation item that was operated on (for item operations)")]
