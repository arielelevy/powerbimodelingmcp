...
// Type: PowerBIModelingMCP.Library.Tools.PartitionOperationResponse
...
public class PartitionOperationResponse
{
  ...
  [Description("The name of the partition that was operated on")]
