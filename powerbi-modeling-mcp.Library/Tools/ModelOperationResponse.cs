...
// Type: PowerBIModelingMCP.Library.Tools.ModelOperationResponse
...
public class ModelOperationResponse
{
  ...
  [Description("The name of the model that was operated on")]
  public string? ModelName { get; set; }

  [Description("Result data for Get and GetStats operations")]
