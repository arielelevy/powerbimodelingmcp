...
// Type: PowerBIModelingMCP.Library.Tools.UserHierarchyOperationResponse
...
public class UserHierarchyOperationResponse
{
  ...
  [Description("The name of the hierarchy that was operated on")]
  public string? HierarchyName { get; set; }

  [Description("The name of the level that was operated on (for level operations)")]
  public string? LevelName { get; set; }

  [Description("Result data for Get, List, and GetColumns operations")]
