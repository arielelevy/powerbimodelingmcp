...
// Type: PowerBIModelingMCP.Library.Tools.NamedExpressionOperationResponse
...
public class NamedExpressionOperationResponse
{
  ...
  [Description("The name of the named expression that was operated on")]
